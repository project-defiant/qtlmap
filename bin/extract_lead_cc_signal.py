...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--qtl_nom_sum", required=True, help="Nominal summary statistics file"
    )
    parser.add_argument(
        "-u",
        "--unique_molecular_trait_ids",
        required=True,
        help="Parquet file with lead signal (phenotype id) generated by build_connected_components process",
    )
    ...
    extract_lead_cc_signal(
        args.qtl_nom_sum,
        args.unique_molecular_trait_ids,
        args.output,
        args.memory_limit,
    )
